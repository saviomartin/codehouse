...
const Hero = ({ setOpen, user, setUser }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: <FiFolderPlus className="text-4xl" />,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-image w-full text-[#ECF2F5] overflow-visible z-10">
      ...
      <div className="h-screen w-full flex items-center justify-center p-7">
