...
export default function Collection({entities, setEntities, collectionId, index}) {
  return (
    <Draggable draggableId={entities.collections[collectionId].id} index={index} isDragDisabled={false}>
      {
        provided => (
          <div className="mb-8 rounded-lg dark:bg-[#ffffff20] border-b-[1px] border-[#eeeeee30]" {...provided.draggableProps} ref={provided.innerRef} style={provided.draggableProps.style}>
